...
public class MancalaDataStructure implements Serializable{
    private static final long serialVersionUID = 203928776832325968L;
    ...
    //helper methods in AyoRules
    int getCurrentIteratorPos() {
        return iteratorPos;
    }

    int getPitPosition(int pitNum) {
        return pitPos(pitNum);
    }
